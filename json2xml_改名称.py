...
im_ext = 'jpg'
COCO_images = '/home/lifan/share/make/darknet_coco/darknet/data/coco/images/train2014/'
Json_addr = '/home/lifan/share/make/darknet_coco/darknet/data/coco/images/annotations_trainval2014/annotations/instances_train2014.json'
im_num = 0
ob_count = 0
im_pairs = dict()
...
for i in range(0, len(annotation_list["annotations"])):
    ...
    if category_id in id_list:
        ...
        for sf in range((len(im_id)), 11):   # imname 12 basamaklı olması için
            z = z + "0"
        im_name = "COCO_train2014_"+z + im_id
